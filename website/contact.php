    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            <a href="index.php" class="navbar-brand d-flex align-items-center text-center py-0 px-4 px-lg-5">
                <h1 class="m-0 text-primary">COLLEGE COMPUS TRACKING</h1>
            </a>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <div class="row g-4">
                        ...
                        <div class="row gy-4">
                            <div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <span>74/27,MULAJORH ROD PRITINGAR,JAGATDAL,NORT24 PARGANAS,WEST BENGAL,743125 INDIA</span>
                                </div>
                            </div>
                    ...
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3676.0876720556807!2d88.40714667509579!3d22.873219521885673!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f896c839d0efc5%3A0xa45dddaa2ce7882!2s22%2C%20Gopi%20Krishna%20Goswami%20Rd%2C%20Bhatpara%2C%20Jagatdal%2C%20Bhatpara%2C%20West%20Bengal%20743126!5e0!3m2!1sen!2sin!4v1744993570399!5m2!1sen!2sin"
                      width="600"
                      height="450"
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            <p class="mb-4">The contact form is currently inactive. Get a functional and working contact form with Ajax & PHP in a few minutes. Just copy and paste the files, add a little code and you're done. <a href="https://htmlcodex.com/contact-form"></a>.</p>
                            <form>
                                <div class="row g-3">
                                    <div class="col-md-6">
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>anubhob40@gmail.con</p>

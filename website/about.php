            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p><i class="fa fa-check text-primary me-3"></i>Introduction to the Online Campus Overview of the platform and its purpose Mission and vision statements.
                            </p>
                        <p><i class="fa fa-check text-primary me-3"></i> Courses & Programs Offered Types of degrees, diplomas, or certifications available Specializations and learning tracks Flexibility in learning (self-paced, live classes, etc).
                            </p>
                        <p><i class="fa fa-check text-primary me-3"></i>Faculty & Staff Brief introduction to instructors and their credentials Availability for student support and mentoring.
                            </p>

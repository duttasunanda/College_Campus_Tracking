    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="login.php" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block active">Login<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </nav>
        <!-- Navbar End -->
        ...
        <!-- login start  -->
        <form class="login mt-5 mx-5" action="adminlogin.php" method="POST">
            ...
            <br><br>
            <br><br>    
            <p class="text-center">Are you student? <a href="login.php">Login here</a></p>
        </form>
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $sql = "SELECT * FROM administrators WHERE college = ? AND username = ? AND password = ?";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("sss", $college, $username, $password);
            $stmt->execute();
            ...
            session_start();
            $_SESSION['admin'] = $record; // Store admin username in session
            echo "<script>alert('Login successful!'); window.location.href='/college_campassing_website/admin/admin.php';</script>";
            } else {
            // Login failed
        ...
        <!-- Back to Top -->
        <a href="adminlogin.php" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
    </div>

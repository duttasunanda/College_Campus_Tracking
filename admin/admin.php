                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4 shadow-lg">
                                    ...
                                    <div class="card-body">
                                        ...
                                        $query = "SELECT company_name FROM job"; // Replace 'jobs' with your actual table name
                                        $result = mysqli_query($conn, $query);

                                        if (mysqli_num_rows($result) > 0) {
                                            echo '<ul class="list-unstyled text-white">';
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                echo '<li><i class="fas fa-check-circle"></i> ' . htmlspecialchars($row['company_name']) . '</li>';
                                            }
                                            echo '</ul>';
                                        } else {
